...
\pagenumbering{Roman}
\titleformat{\chapter}{\centering\xiaoer\hei\bfseries}{\thechapter}{1em}{} % 设置目录两字的格式
...
\fancypagestyle{plain}{                              % 设置开章页眉页脚风格
    ...
    \fancyfoot[C]{\xiaowu\rmfamily ~\thepage~}       % 首页页脚格式
    \renewcommand{\headrulewidth}{0.5pt}
    \renewcommand{\footrulewidth}{0pt}
}
\makeatother
\setcounter{page}{1}                                 % 单独从 1 开始编页码
\titleformat{\chapter}{\centering\xiaosan\hei\bfseries}{\thechapter}{1em}{} % 恢复chapter标题格式要求
